...
class TestKMeans(unittest.TestCase):
    ...
    def test_calculate_distance(self):
        """ Uzaklık hesaplama algoritmasının çalıştığını kontrol et."""
    ...
    def test_kmeans_func(self):
        """K-means algoritmasının çalıştığını kontrol et."""
    ...
    def test_calculate_silhoutte_score(self):
        """Silhouette skorunu hesaplayan fonksiyonun çalıştığını kontrol et."""
